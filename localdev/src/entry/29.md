...
[前のエントリ](http://dskd.jp/archives/11.html)で書いたスニペット（Firefoxで画像を直接見る時のUAスタイル）に、`max-width: 100%;`と`max-height: 100%;`を加えただけ。デモで欲望を満たせる。

[人類の欲望を満たしたデモ](http://dskd.jp/archives/image-size-independent-absolute-centering/)
...
[人類の欲望を満たせないデモ](http://dskd.jp/archives/image-size-independent-absolute-centering/use-display-table.html)
