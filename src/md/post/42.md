...
<a href="/image/multiple-tabs/01.png"><img src="/image/multiple-tabs/01.png" alt="汎用的なタブの例" /></a>

PSD ファイルをこんな感じにしてみました。

<a href="/image/bem-layer-psd/01.png"><img src="/image/bem-layer-psd/01.png" alt="レイヤー名でBEMったスクリーンショット" /></a>
