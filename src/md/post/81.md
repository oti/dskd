...
<img src="/image/pure-css-diagonal-line/length-and-angle.webp" alt="長方形と対角線の長さと角度の関係" />
...
<img src="/image/pure-css-diagonal-line/layer-image.webp" alt="重なりのイメージ" />
...
<img src="/image/pure-css-diagonal-line/edge-no-scrollbar.webp" alt="Edgeでスクロールバーが表示されていない場合" />

<img src="/image/pure-css-diagonal-line/edge-has-scrollbar.webp" alt="Edgeでスクロールバーが表示されている場合" />
...
<img src="/image/pure-css-diagonal-line/mobile-safari-has-gui.webp" alt="Mobile SafariでUIが表示されていない場合](/image/pure-css-diagonal-line/mobile-safari-no-gui.webp) ![Mobile SafariでUIが表示されている場合" />
