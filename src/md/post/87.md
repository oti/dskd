...
<aside aria-label="擬似要素は`CSS3`だと思っている人もいるがそれは違いますね"><p>あまり使われていないので知らない人も多いかもしれないが、<a href="https://www.w3.org/TR/REC-CSS1/#the-first-letter-pseudo-element">first-letter擬似要素はCSS1から使える古参のセレクタ</a>で、CSS2まではコロンは一つだった。<a href="https://www.w3.org/TR/css3-selectors/#selectors">CSS Selectors Level 3でダブルコロンになった</a>。IE8ではダブルコロンの擬似要素を解釈できないのでbeforeやafterにおいてもシングルコロンで記述しなければならないという童話がある。</p>さらに、IE6はfirst-letterとfirst-line擬似要素のコロンはいくつ書いても解釈されるという神話がある。想像してごらん、<code>div::::::first-letter</code>などというバカげたセレクタを解釈するブラウザを。</p></aside>
