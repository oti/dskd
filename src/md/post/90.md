...
<p>LibSassはRuby Sassと互換性が完全でないと思っている人もいるかもしれないが、<a href="http://sass-compatibility.github.io/#stats">LibSass 3.3はRuby Sass 3.4と100%対応したと謳っている</a>。</p>
...
注意点が 1 つ。brackets-sass の stable がコンパイルに利用する[LibSass のバージョンは 3.1](https://github.com/jasonsanjose/brackets-sass#compiler-compatibility)となっており、[このバージョンの Ruby Sass との互換性は 50%を切っている](http://sass-compatibility.github.io/#stats)。
